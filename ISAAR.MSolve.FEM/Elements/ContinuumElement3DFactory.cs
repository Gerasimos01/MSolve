...
namespace ISAAR.MSolve.FEM.Elements
{
    ...
    public class ContinuumElement3DFactory
    {
        ...
        private IContinuumMaterial3D_v2 commonMaterial;
        ...
        public ContinuumElement3DFactory(IContinuumMaterial3D_v2 commonMaterial, DynamicMaterial commonDynamicProperties)
        {
        ...
        public ContinuumElement3D CreateElement(CellType3D cellType, IReadOnlyList<Node_v2> nodes,
            IContinuumMaterial3D_v2 commonMaterial, DynamicMaterial commonDynamicProperties)
        {
            int numGPs = integrationsForStiffness[cellType].IntegrationPoints.Count;
            var materialsAtGaussPoints = new IContinuumMaterial3D_v2[numGPs];
            for (int gp = 0; gp < numGPs; ++gp) materialsAtGaussPoints[gp] = (IContinuumMaterial3D_v2)commonMaterial.Clone();
            return CreateElement(cellType, nodes, materialsAtGaussPoints, commonDynamicProperties);
        }

        public ContinuumElement3D CreateElement(CellType3D cellType, IReadOnlyList<Node_v2> nodes,
            IReadOnlyList<IContinuumMaterial3D_v2> materialsAtGaussPoints, DynamicMaterial commonDynamicProperties)
        {

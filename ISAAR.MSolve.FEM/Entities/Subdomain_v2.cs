...
namespace ISAAR.MSolve.FEM.Entities
{
    public class Subdomain_v2 : ISubdomain_v2
    {
            ...
            int nIncrement, int totalIncrements)
        {
            ...
            foreach (Element_v2 element in Elements)
            {
                double[] localSolution = GetLocalVectorFromGlobalWithoutPrescribedDisplacements(element, solution);
                ...
                double[] localdSolution = GetLocalVectorFromGlobalWithoutPrescribedDisplacements(element, dSolution);
        ...
        private double[] GetLocalVectorFromGlobalWithoutPrescribedDisplacements(Element_v2 element, IVectorView globalDisplacementVector)
        {
            return DofOrdering.ExtractVectorElementFromSubdomain(element, globalDisplacementVector);
        }

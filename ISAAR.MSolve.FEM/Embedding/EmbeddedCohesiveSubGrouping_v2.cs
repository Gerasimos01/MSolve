...
namespace ISAAR.MSolve.PreProcessor.Embedding
{
    public class EmbeddedCohesiveSubGrouping_v2
    {
        ...
        public EmbeddedCohesiveSubGrouping_v2(Model_v2 model, Dictionary<int, IEnumerable<Element>> hostGroups, IEnumerable<Element> embeddedGroup, bool hasEmbeddedRotations)
        {
            this.model = model;
        ...
        public EmbeddedCohesiveSubGrouping_v2(Model_v2 model, Dictionary<int, IEnumerable<Element>> hostGroup, IEnumerable<Element> embeddedGroup)

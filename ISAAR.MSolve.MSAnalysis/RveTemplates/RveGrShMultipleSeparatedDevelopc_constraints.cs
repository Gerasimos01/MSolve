...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparatedDevelopc_constraints : IRVEbuilder //IdegenerateRVEbuilder
    {
        ...
        public RveGrShMultipleSeparatedDevelopc_constraints(int RVE_id)
        {
            this.RVE_id = RVE_id;
        }

        public IRVEbuilder Clone(int a) => new RveGrShMultipleSeparatedDevelopc_constraints(a);
        ...
        private Tuple<Model, Dictionary<int, Node>, double> Reference2RVEExample10000withRenumberingwithInput_forMS()
        {
            ...
            renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_3grsh_4182dofs_multiple2c_constraints\RVE_database\rve_no_{0}\REF_new_total_numbering.txt";
            ...
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_3grsh_4182dofs_multiple2c_constraints\RVE_database\rve_no_{0}\Fxk_p_komvoi_rve.txt";
            ...
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_3grsh_4182dofs_multiple2c_constraints\RVE_database\rve_no_{0}\o_xsunol_gs_";
            ...
            string subdomainOutputPath_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_3grsh_4182dofs_multiple2c_constraints\RVE_database\rve_no_{0}";
            ...
            DefineConstraintsForRotationalDofs(model, subdShellElementIds);
        ...
        private void DefineConstraintsForRotationalDofs(Model model, int[][] subdShellElementIds)
        {
            List<INode> constrainedNodes = new List<INode>();

            foreach (int[] intList in subdShellElementIds)
            {
                if (!(intList == null))
                {
                    foreach (int shellId in intList)
                    {
                        Element element = model.ElementsDictionary[shellId];
            ...
            {
                model.NodesDictionary[node.ID].Constraints.Add(new Constraint { DOF = StructuralDof.RotationX });
                model.NodesDictionary[node.ID].Constraints.Add(new Constraint { DOF = StructuralDof.RotationY });
            }
        }
    }

...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparatedDevelopc : IRVEbuilder //IdegenerateRVEbuilder
    {
        ...
        public RveGrShMultipleSeparatedDevelopc(int RVE_id)
        {
            this.RVE_id = RVE_id;
        }

        public IRVEbuilder Clone(int a) => new RveGrShMultipleSeparatedDevelopc(a);

...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparatedDevelopbDuplicate_2d_alteDevelop : IRVEbuilder //IdegenerateRVEbuilder
    {
        //origin: RveGrShMultipleSeparatedDevelopbDuplicate_2d_alte
        //changes: deveop automatic random orientations 
        ...
        public RveGrShMultipleSeparatedDevelopbDuplicate_2d_alteDevelop(int RVE_id, bool decomposeModel)
        {
            this.RVE_id = RVE_id;
            this.decomposeModel = decomposeModel;
        }

        public IRVEbuilder Clone(int a) => new RveGrShMultipleSeparatedDevelopbDuplicate_2d_alteDevelop(a, decomposeModel);

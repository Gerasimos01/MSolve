...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparated_c_alte : IRVEbuilder //IdegenerateRVEbuilder
    {
        ...
        public RveGrShMultipleSeparated_c_alte(int RVE_id, bool decomposeModel)
        {
            this.RVE_id = RVE_id;
            this.decomposeModel = decomposeModel;
        }

        public IRVEbuilder Clone(int a) => new RveGrShMultipleSeparated_c_alte(a, decomposeModel);

...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparatedDevelopb_Copy : IRVEbuilder //IdegenerateRVEbuilder
    {
        ...
        public RveGrShMultipleSeparatedDevelopb_Copy(int RVE_id)
        {
            this.RVE_id = RVE_id;
        }

        public IRVEbuilder Clone(int a) => new RveGrShMultipleSeparatedDevelopb_Copy(a);

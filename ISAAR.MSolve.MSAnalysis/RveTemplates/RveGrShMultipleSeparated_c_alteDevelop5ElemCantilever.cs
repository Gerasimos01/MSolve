...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public class RveGrShMultipleSeparated_c_alteDevelop5elemCantilever : IRVEbuilderDevelop //IdegenerateRVEbuilder
    {
        ...
        public RveGrShMultipleSeparated_c_alteDevelop5elemCantilever(int RVE_id, bool decomposeModel)
        {
            this.RVE_id = RVE_id;
            this.decomposeModel = decomposeModel;
        }

        public IRVEbuilderDevelop Clone(int a) => new RveGrShMultipleSeparated_c_alteDevelop5elemCantilever(a, decomposeModel);
        ...
        private Tuple<Model, Dictionary<int, Node>, double> Reference2RVEExample10000withRenumberingwithInput_forMS()
        {
            ...
            if (path == 2) renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\2c_alte_5elemCantilever\RVE_database\rve_no_{0}\REF_new_total_numbering.txt";
            ...
            if (path == 2) Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\2c_alte_5elemCantilever\RVE_database\rve_no_{0}\Fxk_p_komvoi_rve.txt";
            ...
            if (path == 2) o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\2c_alte_5elemCantilever\RVE_database\rve_no_{0}\o_xsunol_gs_";
            ...
            if (path == 2) subdomainOutputPath_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\2c_alte_5elemCantilever\RVE_database\rve_no_{0}";
            ...
            //A.9
            mp = mpgp.Item1; mp.hexa1 = 4; mp.hexa2 = 1; mp.hexa3 = 1;

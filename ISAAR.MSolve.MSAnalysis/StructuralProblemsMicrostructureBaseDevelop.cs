...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    ...
    /// </summary>
    public abstract class StructuralProblemsMicrostructureBaseDevelop
    {
        ...
        public virtual (MicrostructureBvpNRNLAnalyzerDevelop, ProblemStructural,ElementStructuralStiffnessProvider) AnalyzeMicrostructure(Model model,  ISolver solver,
            ...
            Dictionary<int, Dictionary<IDofType, double>> initialConvergedBoundaryDisplacements, Dictionary<int, Node> boundaryNodes, Dictionary<int, IVector> uInitialFreeDOFDisplacementsPerSubdomain)
        {
            ...
            MicrostructureBvpNRNLAnalyzerDevelop microAnalyzer = new MicrostructureBvpNRNLAnalyzerDevelop(model,solver, subdomainUpdaters, 

...
{
	 public class ShellElasticMaterial2DtransformationbCheck : IShellMaterial
	{
		...
		{
			return new ShellElasticMaterial2DtransformationbCheck()
			{
        ...
        private void CalculateTransformationMatrix(Vector surfaceBasisVector1, Vector surfaceBasisVector2)
        {
            ...
            for (int i1 = 0; i1 < 3; i1++) { Ei[1][i1] = surfaceBasisVector2[i1] ; }

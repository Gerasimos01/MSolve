...
{
    public class ElasticMaterial3D_v2Ger : IContinuumMaterial3D, IIsotropicContinuumMaterial3D
    {
        ...
        StressStrainVectorContinuum3D IContinuumMaterial3D.Stresses => throw new NotImplementedException();

        ElasticityTensorContinuum3D IContinuumMaterial3D.ConstitutiveMatrix => throw new NotImplementedException();
        ...
        public object Clone()
        {
            return new ElasticMaterial3D_v2Ger() { YoungModulus = this.YoungModulus, PoissonRatio = this.PoissonRatio };
        }

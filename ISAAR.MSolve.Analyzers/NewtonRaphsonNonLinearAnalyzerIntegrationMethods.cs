...
{
    public class NewtonRaphsonNonLinearAnalyzerIntegrationMethods : IAnalyzer
    {
        ...
        public NewtonRaphsonNonLinearAnalyzerIntegrationMethods(ISolver solver, ILinearSystem[] linearSystems, INonLinearSubdomainUpdater[] subdomainUpdaters, ISubdomainGlobalMapping[] mappings,
        ...
        public double[,] IntegrateConstitutiveMatrix(IScaleTransitions scaleTransitions)
        {

            //double[][] KfpDqVectors = SubdomainCalculations.CalculateKfreeprescribedDqMultiplications(mappings[0],  scaleTransitions, boundaryNodes);

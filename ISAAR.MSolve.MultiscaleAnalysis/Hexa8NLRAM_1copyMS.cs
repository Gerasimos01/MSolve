...
{
    public class Hexa8NLRAM_1copyMS : IStructuralFiniteElement , IEmbeddedHostElement
    {
        ...
        protected Hexa8NLRAM_1copyMS()//consztructor apo to hexa8
        {
        }

        public Hexa8NLRAM_1copyMS(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c, int gp_d3c)
        {

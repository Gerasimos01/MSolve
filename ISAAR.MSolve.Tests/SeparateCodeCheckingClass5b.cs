...
{
    public class SeparateCodeCheckingClass5b
    {
        ...
        public static void RunExampleSerial()
        {
            ...
            //// Request output
            //int[] outputPositions = new int[model.SubdomainsDictionary[1].FreeDofOrdering.NumFreeDofs];
            //for( int i1 = 0;  i1 < model.SubdomainsDictionary[1].FreeDofOrdering.NumFreeDofs ; i1++ )
            //{

...
namespace ISAAR.MSolve.Discretization.Embedding
{
    public class EmbeddedNode
    {
        private readonly INode node;
        private readonly IElement embeddedInElement;
        ...
        public IElement EmbeddedInElement { get { return embeddedInElement; } }
        public IList<DOFType> DependentDOFs { get { return dependentDOFs; } }
        public IList<double> Coordinates { get { return coordinates; } }

        public EmbeddedNode(INode node, IElement hostElement, IList<DOFType> dependentDOFs)
        {
            this.node = node;

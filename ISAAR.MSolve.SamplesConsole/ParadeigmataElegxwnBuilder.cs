...
{
    class ParadeigmataElegxwnBuilder //PROSOXH: einai aplo copy apo to nl_elements_test kai exei mono compatiblity allages kai oxi ousiwdhs opws na epilegei to Microstructure3UsebaseSimuRand klp
    {
        ...
        public static void HexaCantileverBuilder_material_fromMS(Model model, double load_value)
        {
            ElasticMaterial3D material1 = new ElasticMaterial3D()
            {
                YoungModulus = 3.5,
        ...
        public static void HexaCantileverBuilder_copyMS(Model model, double load_value)
        {
            ...
            IContinuumMaterial3DDefGrad material1 = new Microstructure3Develop(homogeneousRveBuilder1);
        ...
        public static void HexaCantileverBuilder_material_fromMS_222(Model model, double load_value)
        {
            ElasticMaterial3D material1 = new ElasticMaterial3D()
            {
                YoungModulus = 3.5,
            ...
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                ...
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NonLinear(material1, GaussLegendre3D.GetQuadratureWithOrder(2,2,2)) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8
                };
                for (int j = 0; j < 8; j++)
                {
                    e1.NodesDictionary.Add(elementData[nElement, j + 1], model.NodesDictionary[elementData[nElement, j + 1]]);
        ...
        public static void HexaCantileverBuilder_copyMS_222(Model model, double load_value)//Checked
        {
            // apotelesmata neo : C:\Users\turbo-x\Desktop\notes_elegxoi\MSOLVE_output_2\APOTELESMATA_MS_hexa8_cantilever_nea\public static void HexaCantileverBuilder_copyMS_222
            //ElasticMaterial3D material1 = new ElasticMaterial3D()
            //{
            //    YoungModulus = 1353000,
            //    PoissonRatio = 0.3,
        ...
        {
            //einai copy pou Xrhsimopoithike me to Hexa8NLRAM_1copyMSPrintStrainHist
            ...
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                ...
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NonLinearDefGrad(material1, GaussLegendre3D.GetQuadratureWithOrder(2,2,2)) // edw eixe xrhsimopoiithei Hexa8NLRAM_1copyMSPrintStrainHist
                };
                for (int j = 0; j < 8; j++)
                {
                    e1.NodesDictionary.Add(elementData[nElement, j + 1], model.NodesDictionary[elementData[nElement, j + 1]]);
        ...
        public static void ShellAndCohesiveShellPaktwsh(Model model)
        {
            ...
            // perioxh materials 
            BenzeggaghKenaneCohesiveMaterial material1 = new Materials.BenzeggaghKenaneCohesiveMaterial()
            {

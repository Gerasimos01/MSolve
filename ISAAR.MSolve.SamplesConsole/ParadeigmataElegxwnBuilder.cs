    ...
    class ParadeigmataElegxwnBuilder
    {
        ...
        public static void HexaCantileverBuilder_material_fromMS_222(Model model, double load_value)
        {
            ...
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                ...
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NLRAM_1(material1, 2, 2, 2) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8
                };
                for (int j = 0; j < 8; j++)
                {
                    e1.NodesDictionary.Add(elementData[nElement, j + 1], model.NodesDictionary[elementData[nElement, j + 1]]);
        ...
        public static void HexaCantileverBuilder_copyMS_222(Model model, double load_value)
        {
            ...
            IRVEbuilder homogeneousRveBuilder1 = new HomogeneousRVEBuilderCheck125Hexa();
            //IRVEbuilder homogeneousRveBuilder1 = new HomogeneousRVEBuilderCheckEnaHexa();
            ...
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                ...
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NLRAM_1copyMS(material1, 2, 2, 2) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8
                };
                for (int j = 0; j < 8; j++)
                {
                    e1.NodesDictionary.Add(elementData[nElement, j + 1], model.NodesDictionary[elementData[nElement, j + 1]]);

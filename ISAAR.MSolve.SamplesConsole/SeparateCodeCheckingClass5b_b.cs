...
namespace ISAAR.MSolve.SamplesConsole
{
    public class SeparateCodeCheckingClass5b_b
    {
        ...
        public static (Model, double[]) RunExampleSerial()
        {
            ...
            var renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post_dg\2c_alte_5elem\RVE_database\rve_no_{0}\REF_new_total_numbering.txt"; //A.2
            ...
            //A.9
            var mp = mpgp.Item1; mp.hexa1 = 2; mp.hexa2 = 1; mp.hexa3 = 1;
            var gp = mpgp.Item2;

...
{
    public class SeparateCodeCheckingClass5b_bNEW_debugGitOverlap
    {//check unpushed changes commit
        ...
        public static (Model, double[], Vector, bool) RunExample()
        {
            ...
            var rveBuilder = new RveGrShMultipleSeparatedDevelopbDuplicate_2d_alteDevelop3DcornerGitOverlapping(1, true, mpgp,
            subdiscr1, discr1, discr3, subdiscr1_shell, discr1_shell, graphene_sheets_number);
        ...
        public static (Model, double[], Vector) RunExampleSerial()
        {
            ...
            var rveBuilder = new RveGrShMultipleSeparatedDevelopbDuplicate_2d_alteDevelop3DcornerGitOverlapping(1, false, mpgp,
            subdiscr1, discr1, discr3, subdiscr1_shell, discr1_shell, graphene_sheets_number);
            rveBuilder.useInput = false;

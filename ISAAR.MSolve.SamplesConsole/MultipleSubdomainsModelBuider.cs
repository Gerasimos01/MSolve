...
{
    public class MultipleSubdomainsModelBuider
    {
        ...
        public static Model CreateModel()
        {
            ...
            {
                for (int i2 = 0; i2 < SubdElements.GetLength(2); i2++)
                {
                    int subdomainID = subdomainIds[i1];
                    model.SubdomainsDictionary[subdomainID].Elements.Add(model.ElementsDictionary[SubdElements[i1,i2]]);
                }
            }
        ...
        public static (int[], int[], int[], int[], int[,], double[,], int[,]) GetModelCreationData()
        {

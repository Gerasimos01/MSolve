...
namespace ISAAR.MSolve.SamplesConsole
{
    class SeparateCodeCheckingClass4
    {
        ...
        public static void Check_Graphene_rve_Obje_v2_Integration()
        {
            ...
            VectorExtensions.AssignTotalAffinityCount();
            IRVEbuilder homogeneousRveBuilder1 = new GrapheneReinforcedRVEBuilderExample35fe2boundstiffHostTestPostData_forCheck_v1(1);
            //IRVEbuilder homogeneousRveBuilder1 = new HomogeneousRVEBuilderCheckEnaHexa();

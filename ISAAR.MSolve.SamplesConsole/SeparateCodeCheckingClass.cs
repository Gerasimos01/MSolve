...
namespace ISAAR.MSolve.SamplesConsole
{
    class SeparateCodeCheckingClass
    {
        ...
        public static void Check05h3StressIntegration()
        {
            //proelefsi: Check05hStressIntegration
            // allages: simultaneuoscalculations
            ...
            var material4 = new Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimu(homogeneousRveBuilder1,false) { TangentVectorV1 = new double[3] { Vec1[0], Vec1[1], Vec1[2] }, TangentVectorV2 = new double[3] { Vec2[0], Vec2[1], Vec2[2] } }; ;
            var Matrix2 = new Matrix2D(3, 3); for (int i1 = 0; i1 < 3; i1++) { for (int i2 = 0; i2 < 3; i2++) { Matrix2[i1, i2] = material4.ConstitutiveMatrix[i1, i2]; } }
            material4.UpdateMaterial(strain);
            double[] stressesCheck4 = new double[3] { material4.Stresses[0], material4.Stresses[1], material4.Stresses[2] };
        ...
        public static void Check05h4StressIntegration()
        {
            //proelefsi: Check05hStressIntegration
            // allages: elegxos matlab processing !
            ...
            VectorExtensions.AssignTotalAffinityCount();
            IdegenerateRVEbuilder homogeneousRveBuilder1 = new GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPost();
            //IRVEbuilder homogeneousRveBuilder1 = new HomogeneousRVEBuilderCheckEnaHexa();
        ...
        public static void Check05h3ConstiOnlyStressIntegration()
        {
            //proelefsi: Check05hStressIntegration
            // allages: simultaneuoscalculations
        ...
        public static void Check05h4SharedRvesConst()
        {
            //PROELEFSI: exei stoixeia apo to Check05h4StressIntegration()        
            VectorExtensions.AssignTotalAffinityCount();
            var Vec1 = new Vector(new double[3] { 1, 0, 0 });
            ...
            //proswrina exoun allaxthei ta data sto path tou parakatw graphene builder gia na trexoume apo database me 10 rves
            IdegenerateRVEbuilder RveBuilder3 = new GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPostData(1);
            var BasicMaterial = new Shell2dRVEMaterialHostConst(2, 2, 0, RveBuilder3);
        ...
        public static void ExampleParametricStudy2CyclicConference()
        {
            //proelefsi Check10cStressIntegration5GrSh1RveForDemonstration
            //allages to 1)strainhistory, 2)to uliko shell to 3)graohene builder kai 4)parametroi cohesive tha ginei parametriko
            ...
            //IContinuumMaterial3DDefGrad microstructure3 = new Microstructure3Develop(homogeneousRveBuilder1);
            //neo paradeigma:
            IdegenerateRVEbuilder RveBuilder1 = new GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPostData(9);
            var Vec1 = new Vector(new double[3] { 1, 0, 0 });
            var Vec2 = new Vector(new double[3] { 0, 1, 0 });
            var material4 = new Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimu(RveBuilder1, false) { TangentVectorV1 = new double[3] { Vec1[0], Vec1[1], Vec1[2] }, TangentVectorV2 = new double[3] { Vec2[0], Vec2[1], Vec2[2] } }; ;

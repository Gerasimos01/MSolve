...
{
    public class GrapheneReinforcedRVEBuilderExample10GrSh1RVEstifDegenAndLinearPeripheralHostTestPostData : IdegenerateRVEbuilder
    {
        ...
        public GrapheneReinforcedRVEBuilderExample10GrSh1RVEstifDegenAndLinearPeripheralHostTestPostData(int RVE_id)
        {
            this.RVE_id = RVE_id;
        }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample10GrSh1RVEstifDegenAndLinearPeripheralHostTestPostData(a);
        ...
        private Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample10000withRenumberingwithInput_forMS()
        {
            ...
            renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_Kanonikh_gewmetria_fe2_post2\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_10grsh_4182dofs_multiple2\RVE_database\rve_no_{0}\REF_new_total_numbering.txt";
            renumbering_vector_path = string.Format(renumbering_vector_path, rve_id_data);
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_Kanonikh_gewmetria_fe2_post2\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_10grsh_4182dofs_multiple2\RVE_database\rve_no_{0}\Fxk_p_komvoi_rve.txt";
            Fxk_p_komvoi_rve_path = string.Format(Fxk_p_komvoi_rve_path, rve_id_data);
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_Kanonikh_gewmetria_fe2_post2\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_10grsh_4182dofs_multiple2\RVE_database\rve_no_{0}\o_xsunol_gs_";

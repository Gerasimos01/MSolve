...
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimuRand : StructuralProblemsMicrostructureBase, IShellMaterial //A.1
    {
        ...
        public Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimuRand(IdegenerateRVEbuilder rveBuilder,bool EstimateOnlyLinearResponse, int database_size)
        {
        ...
        public IShellMaterial Clone()
        {
            ...
            return new Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimuRand((IdegenerateRVEbuilder)rveBuilder.Clone(new_rve_id),EstimateOnlyLinearResponse,database_size);
        }
        ...
        public void UpdateMaterial(double[] smallStrainVec)
        {
            ...
            //antikathistatai apo simulatneous methods:

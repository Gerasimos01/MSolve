...
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSimuRandObj : StructuralProblemsMicrostructureBase, IContinuumMaterial3DDefGrad
    {
        ...
        public Microstructure3DevelopMultipleSubdomainsUseBaseSimuRandObj(IRVEbuilder rveBuilder, bool EstimateOnlyLinearResponse, int database_size)
        {
        ...
        public object Clone()
        {
            ...
            return new Microstructure3DevelopMultipleSubdomainsUseBaseSimuRandObj(rveBuilder.Clone(new_rve_id), EstimateOnlyLinearResponse, database_size);
        }
        ...
        public void UpdateMaterial(double[] DefGradVec)
        {
            ...
            var integrationSimultaneous = new SubdomainCalculationsSimultaneousObje();
            (Dictionary<int, double[][]> KfpDqSubdomains, Dictionary<int, double[][]> KppDqVectorsSubdomains) = 
                integrationSimultaneous.UpdateSubdomainKffAndCalculateKfpDqAndKppDqpMultipleObje(model, elementProvider, scaleTransitions, boundaryNodes, boundaryElements, linearSystems);

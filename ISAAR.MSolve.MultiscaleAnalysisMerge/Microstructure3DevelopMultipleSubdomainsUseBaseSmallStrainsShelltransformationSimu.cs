...
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSmallStrainsShelltransformationSimu : StructuralProblemsMicrostructureBase, IShellMaterial //A.1
    {

...
{
    public class GrapheneReinforcedRVEBuilderCHECKddmExampleB1verticalSlip : IRVEbuilder
    {
        //Proelefsi GrapheneReinforcedRVEBuilderCHECKddmExampleB1vertical

        public rveMatrixParameters mp { get; set; }
        public grapheneSheetParameters gp { get; set; }
        public Tuple<rveMatrixParameters, grapheneSheetParameters> mpgp;

        public GrapheneReinforcedRVEBuilderCHECKddmExampleB1verticalSlip()
        {
            //ean ston constructor dinoume parametrous px mp gp mpgp tote apla prepei na 
            //lkanoume comment out tis grammes pou tha pane na grapsouna po panw mpgp=..., mp=..., mp(...)=..., gp=... klp sthn methodo pou xtizei to montelo (grammes 64,65,66) 
        }
        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderCHECKddmExampleB1verticalSlip();
        ...
        private Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample1000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2_slip\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2_slip\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2_slip\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 6;
            int discr1 = 4;

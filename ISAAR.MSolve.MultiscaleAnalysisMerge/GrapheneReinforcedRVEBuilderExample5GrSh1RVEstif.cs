...
{
    public class GrapheneReinforcedRVEBuilderExample5GrSh1RVEstif : IRVEbuilder
    {
        //PROELEFSI GrapheneReinforcedRVEBuilderExample5GrSh1RVE allagh parameters kai bond slip 
        public GrapheneReinforcedRVEBuilderExample5GrSh1RVEstif()
        { }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample5GrSh1RVEstif();
        ...
        private static Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample10000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_5grsh_1RVE\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_5grsh_1RVE\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_5grsh_1RVE\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 4;
            int discr1 = 4;
            // int discr2 dn xrhsimopoieitai
            int discr3 = 10;
            int subdiscr1_shell = 5;
            int discr1_shell = 1;

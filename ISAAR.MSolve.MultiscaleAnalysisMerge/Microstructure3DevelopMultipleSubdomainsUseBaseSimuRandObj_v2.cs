...
namespace ISAAR.MSolve.MultiscaleAnalysis
{
    public class Microstructure3DevelopMultipleSubdomainsUseBaseSimuRandObj_v2 : StructuralProblemsMicrostructureBase_v2, IContinuumMaterial3DDefGrad
    {
        ...
        {
            Tuple<Model_v2, Dictionary<int, Node>, double> modelAndBoundaryNodes = this.rveBuilder.GetModelAndBoundaryNodes();
        ...
        public void UpdateMaterial(double[] DefGradVec)
        {
            ...
            (NewtonRaphsonNonLinearAnalyzerDevelopCopy microAnalyzer, ProblemStructural_v2 provider, ElementStructuralStiffnessProvider elementProvider) = 

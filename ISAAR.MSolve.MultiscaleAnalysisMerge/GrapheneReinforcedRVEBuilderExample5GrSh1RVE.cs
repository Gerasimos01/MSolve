...
{
    public class GrapheneReinforcedRVEBuilderExample5GrSh1RVE : IRVEbuilder
    {
        public GrapheneReinforcedRVEBuilderExample5GrSh1RVE()
        { }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample5GrSh1RVE();

...
{
    public class GrapheneReinforcedRVEBuilderExample35fe2boundstiffHostTestPostData_forCheck_v1 : IRVEbuilder //IdegenerateRVEbuilder
    {
        //PROELEFSI GrapheneReinforcedRVEBuilderExample35fe2boundstiffHostTestPostData_v2 opou eixame tis parakatw allages twra to kaname v1 gia na to trexoumegia sugkrisi
        ...
        public GrapheneReinforcedRVEBuilderExample35fe2boundstiffHostTestPostData_forCheck_v1(int RVE_id)
        {
            this.RVE_id = RVE_id;
        }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample35fe2boundstiffHostTestPostData_forCheck_v1(a);

...
{
    public class GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPostDataGP : IdegenerateRVEbuilder
    {
        ...
        public GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPostDataGP(int RVE_id, grapheneSheetParameters gpNeo)
        {
            this.RVE_id = RVE_id;
            this.gpNeo = gpNeo;
        }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample3GrSh1RVEstifDegenAndLinearPeripheralHostTestPostDataGP(a,gpNeo);

...
{
    public class SubdomainCalculationsSimultaneousObje
    {
            ...
            Dictionary<int, Node> boundaryNodes, Dictionary<int, Element> boundaryElements)
        {
            ...
            Dictionary<int, int> boundaryNodesOrder = SubdomainCalculations.GetNodesOrderInDictionary(boundaryNodes);
            for (int j1 = 0; j1 < scaleTransitions.MacroscaleVariableDimension(); j1++)
            {
        ...
        Dictionary<int, Dictionary<DOFType, int>> nodalDOFsDictionary;
            ...
            Dictionary<int, Node> boundaryNodes, Dictionary<int, Dictionary<int, Element>> boundaryElements, Dictionary<int, ILinearSystem> linearSystems)
        {
            ...
            {
                nodalDOFsDictionary = subdomain.NodalDOFsDictionary;
                ...
                var subdomainK= GlobalMatrixAssemblerSkyline.CalculateFreeFreeGlobalMatrix(subdomain, StiffnessProvider);
        ...
        public void UpdateVectors(IElement element, IMatrix2D ElementK)
        {
            if (boundaryElements[currentSubdomainID].ContainsKey(element.ID))//COPIED From UpdateSubdomainKffAndCalculateKfpDqAndKppDqp (prosoxh boundary elements Dictionary diathetoun kai to model kai to subdomain kai einai diaforetika edw exei diorthwthei
            {
                ...
                var isEmbeddedElement = element.IElementType is ISAAR.MSolve.FEM.Interfaces.IEmbeddedElement;

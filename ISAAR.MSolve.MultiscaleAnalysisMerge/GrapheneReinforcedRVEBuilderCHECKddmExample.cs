...
{
    public class GrapheneReinforcedRVEBuilderCHECKddmExample : IRVEbuilder
    {
        public GrapheneReinforcedRVEBuilderCHECKddmExample()
        { }

        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderCHECKddmExample();
        ...
        private static Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample1000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 6;
            int discr1 = 4;

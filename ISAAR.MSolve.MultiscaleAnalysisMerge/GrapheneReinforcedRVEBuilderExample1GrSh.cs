...
{
    public class GrapheneReinforcedRVEBuilderExample1GrSh : IRVEbuilder
    {
        public GrapheneReinforcedRVEBuilderExample1GrSh()
        { }
        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderExample1GrSh();
        ...
        private static Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample10000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_1grsh_7368dofs\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_1grsh_7368dofs\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_fe2_post\REF2_10__000_renu_new_multiple_algorithms_check_develop_gia_fe2_1grsh_7368dofs\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 4;
            int discr1 = 4;
            ...
            mp = mpgp.Item1; mp.hexa1 = 8; mp.hexa2 = 8; mp.hexa3 = 8;
            gp = mpgp.Item2;

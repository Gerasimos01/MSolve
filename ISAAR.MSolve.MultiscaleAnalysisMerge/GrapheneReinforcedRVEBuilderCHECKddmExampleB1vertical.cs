...
{
    public class GrapheneReinforcedRVEBuilderCHECKddmExampleB1vertical : IRVEbuilder
    {
        ...
        public GrapheneReinforcedRVEBuilderCHECKddmExampleB1vertical()
        {
        ...
        public IRVEbuilder Clone(int a) => new GrapheneReinforcedRVEBuilderCHECKddmExampleB1vertical();
        ...
        private Tuple<Model, Dictionary<int, Node>,double> Reference2RVEExample1000withRenumberingwithInput_forMS()
        {
            ...
            string renumbering_vector_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2\REF_new_total_numbering.txt";
            string Fxk_p_komvoi_rve_path = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2\Fxk_p_komvoi_rve.txt";
            string o_xsunol_input_path_gen = @"C:\Users\turbo-x\Desktop\notes_elegxoi\REFERENCE_kanonikh_gewmetria_2\REF2_10__000_renu_new_multiple_algorithms_check_develop_1GrSh_correct_coh_CHECK_integration_ddm_example_2\o_xsunol_gs_{0}.txt";
            int subdiscr1 = 6;
            int discr1 = 4;

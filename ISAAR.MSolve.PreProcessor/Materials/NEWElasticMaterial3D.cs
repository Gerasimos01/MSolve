...
{
    public class NEWElasticMaterial3D : IFiniteElementMaterial3D
    {
        ...
        public object Clone()
        {
            return new NEWElasticMaterial3D() { YoungModulus = this.YoungModulus, PoissonRatio = this.PoissonRatio };
        }

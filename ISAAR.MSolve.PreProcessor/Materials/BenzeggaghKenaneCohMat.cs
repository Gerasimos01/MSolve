...
{
    public class BenzeggaghKenaneCohMat : IFiniteElementMaterial3D // ean de vazamr to public sto class de tha mporousame na orisoume uliko sto hexaBuilder
    {
        ...
        public IMatrix2D<double> ConstitutiveMatrix
        {
            get
            {
                ...
                return new Matrix2D<double>(D_tan);
            }
        }

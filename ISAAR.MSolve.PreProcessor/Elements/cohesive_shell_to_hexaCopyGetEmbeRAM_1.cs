...
{
    public class cohesive_shell_to_hexaCopyGetEmbeRAM_1 : IStructuralFiniteElement, IEmbeddedElement
    {
        ...
        protected cohesive_shell_to_hexaCopyGetEmbeRAM_1()//consztructor apo to hexa8
        {
        }

        public cohesive_shell_to_hexaCopyGetEmbeRAM_1(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c)
        {

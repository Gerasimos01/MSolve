...
{
    public class Shell8dispCopyGetRAM_1_material : IStructuralFiniteElement
    {
        ...
        protected Shell8dispCopyGetRAM_1_material()//consztructor apo to hexa8
        {
        }

        public Shell8dispCopyGetRAM_1_material(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c, int gp_d3c)
        {
            this.gp_d1 = gp_d1c;
            this.gp_d2 = gp_d2c;
            this.gp_d3 = gp_d3c;
        ...
        private void CalculateInitialConfigurationData(Element element)
        {
            ...
            for (int j = 0; j < nGaussPoints; j++)
            {
                ...
                for (int k = 0; k < 6; k++)
                {
                    for (int l = 0; l < 6; l++)
                    {
                        Cons[k,l] = materialsAtGaussPoints[j].ConstitutiveMatrix[k,l];
                    }
                }

...
{
    public class cohesive_shell_to_hexaCopyGetEmbe : IStructuralFiniteElement, IEmbeddedElement
    {
        ...
        protected cohesive_shell_to_hexaCopyGetEmbe()//consztructor apo to hexa8
        {
        }

        public cohesive_shell_to_hexaCopyGetEmbe(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c)
        {

...
{
    public class cohesive16node : IStructuralFiniteElement
    {
        ...
        protected cohesive16node()//consztructor apo to hexa8
        {
        }

        public cohesive16node(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c)
        {
        ...
        {
            ox_i = new double[16][];
            tx_i = new double[16][]; //mporei na mhn xreiasthei teilka!!!!
            for (int j = 0; j < 16; j++)
            {

...
{
    public class cohesive_shell_to_hexaCopyGetEmbeRAM_11 : IStructuralFiniteElement, IEmbeddedElement
    {
        ...
        protected cohesive_shell_to_hexaCopyGetEmbeRAM_11()//consztructor apo to hexa8
        {
        }

        public cohesive_shell_to_hexaCopyGetEmbeRAM_11(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c)
        {
        ...
        private Tuple<double[][,], double[]> CalculateNecessaryMatricesForStiffnessMatrixAndForcesVectorCalculations() // sto shell8disp sto calculate forces kaleitai me this.UpdateCoordinateData(localTotalDisplacements);
        {
            ...
            double [] [,] RN3 = new double[nGaussPoints][,];
            ...
            //this.UpdateTMatrix();
            //print_counter += 1;
            Tuple<double[][,], double[]> RN3AndSunt_olokl = new Tuple<double[][,], double[]>(RN3, sunt_olokl);
            return RN3AndSunt_olokl;
        }
        ...
        private double[] UpdateForces(Element element, double[][,] RN3, double[] sunt_olokl)
        {
            double [] fxk2_coh = new double[64];
        ...
        private double [,] UpdateKmatrices(Element element, double[][,] RN3, double[] sunt_olokl)
        {
            double [,] k_stoixeiou_coh2 = new double[64, 64];
        ...
        public double[] CalculateForces(Element element, double[] localTotalDisplacementsSuperElement, double[] localdDisplacementsSuperelement)
        {
            ...
            //}
            Tuple<double[][,], double[]> RN3AndSunt_olokl;
            RN3AndSunt_olokl = CalculateNecessaryMatricesForStiffnessMatrixAndForcesVectorCalculations();
            double[][,] RN3;
            RN3 = RN3AndSunt_olokl.Item1;
            double[] sunt_olokl; //osa kai ta gpoints
            sunt_olokl = RN3AndSunt_olokl.Item2;

            fxk2_coh = this.UpdateForces(element,RN3,sunt_olokl); //<-- sto Update afto exei enswmatwthei to Tt*fxk1_coh
            //return fxk1_coh;
        ...
        public virtual IMatrix2D<double> StiffnessMatrix(Element element)
        {
            ...
            k_stoixeiou_coh2 =this.UpdateKmatrices(element, RN3, sunt_olokl); //<-- sto Update afto exei mpei to Tt*K*T 

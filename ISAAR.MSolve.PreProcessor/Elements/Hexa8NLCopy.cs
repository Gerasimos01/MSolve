...
{
    public class Hexa8NLCopy : IStructuralFiniteElement //, IEmbeddedHostElement
    {
        ...
        protected Hexa8NLCopy()//consztructor apo to hexa8
        {
        }

        public Hexa8NLCopy(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c, int gp_d3c)
        {

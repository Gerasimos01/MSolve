...
{
    public class Hexa8NLRAM_1 : IStructuralFiniteElement , IEmbeddedHostElement
    {
        ...
        protected Hexa8NLRAM_1()//consztructor apo to hexa8
        {
        }

        public Hexa8NLRAM_1(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c, int gp_d3c)
        {

...
{
    public class Hexa8NLRAM : IStructuralFiniteElement , IEmbeddedHostElement
    {
        ...
        protected Hexa8NLRAM()//consztructor apo to hexa8
        {
        }

        public Hexa8NLRAM(IFiniteElementMaterial3D material, int gp_d1c, int gp_d2c, int gp_d3c)
        {

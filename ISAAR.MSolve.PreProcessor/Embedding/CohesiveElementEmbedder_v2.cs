...
namespace ISAAR.MSolve.PreProcessor.Embedding
{
    ...
    public class CohesiveElementEmbedder_v2 : IFiniteElementDOFEnumerator
    {
        ...
        private Sparse2D_v2<double> transformationMatrix;
        ////EMBEDDED:
        //public Matrix2D<double> transformationMatrix;

        //private bool isElementEmbedded = false;

        public CohesiveElementEmbedder_v2(Model model, Element embeddedElement, IEmbeddedDOFInHostTransformationVector transformation)
        {
            this.model = model;
        ...
        public IMatrix2D<double> GetTransformedMatrix(IMatrix2D<double> matrix)
        {
            ...
            Matrix2D<double> KT = transformationMatrix.MultiplyLeft(matrix);
            return transformationMatrix.Transpose().MultiplyRight(KT);
        }
        ...
        public double[] GetTransformedVector(double[] vector)
        {
            ...
            return transformationMatrix.MultiplyRight(vector);
        }
        ...
        public double[] GetTransformedForcesVector(double[] vector)
        {
            ...
            return transformationMatrix.Transpose().MultiplyRight(vector);
        }

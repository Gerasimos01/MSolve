...
namespace ISAAR.MSolve.PreProcessor.Embedding
{
    public class EmbeddedCohesiveGrouping_v2
    {
        ...
        public EmbeddedCohesiveGrouping_v2(Model model, IEnumerable<Element> hostGroup, IEnumerable<Element> embeddedGroup, bool hasEmbeddedRotations)
        {
            this.model = model;
        ...
        public EmbeddedCohesiveGrouping_v2(Model model, IEnumerable<Element> hostGroup, IEnumerable<Element> embeddedGroup)
